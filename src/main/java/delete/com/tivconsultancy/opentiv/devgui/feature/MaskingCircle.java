 ...
 */
public class MaskingCircle implements Feature{

    public int iPosX = 0;
    public int iPosY = 0;
    public Double dNorm = 0.0;
    public double dNormPot = 2;
    ...
    public String getDescription() {
        return "Masks an area in a shape of a cricle";
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof Feature){
            if(this.getName().equals( ((Feature) o).getName())){
                if (((MaskingCircle) o).iPosX == this.iPosX && ((MaskingCircle) o).iPosY == iPosY && ((MaskingCircle) o).dNorm == this.dNorm && ((MaskingCircle) o).dNormPot == this.dNormPot) {
                    return true;
                }
            }
        }
